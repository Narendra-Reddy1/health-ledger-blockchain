...
contract HealthLedger is Ownable, ReentrancyGuard {
    ...
    event PrizeDistributedToWinner(address, uint256);
    ...
    //NFT minting
    //ERC-20 tokens minting. //"HealthLedgerToken"  "HLT" onlyOwner
    //recording participation.
    //recording user step count.
    ...
    //Automate this thing with ChainLink Automation
    //to reward users on tournament ends.
    //Added OnlyOwner to pay gas fee only.
